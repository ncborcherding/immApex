...
```{r include = FALSE}
# Set a temporary, writable directory for ALL basilisk operations.
Sys.setenv(BASILISK_CACHE_DIR = tempdir())
```
...
```{r include = FALSE}
# Trigger the one-time build of the Python environment
basilisk::basiliskRun(env = immApex:::immApexEnv, fun = function() {
  invisible(NULL)
})
```
...
* **property.set** For `mode = "property"`, a character vector of property names.
*  **number.of.sequences** Number of sequences to generate
