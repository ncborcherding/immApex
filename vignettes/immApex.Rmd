...
# Repertoire Analysis and Feature Engineering
...
* sequence.dictionary: The set of valid residues to track.
...
* input.sequences: A character vector of amino acid sequences.
...
atchley.profile <- calculateProperty(sequences, property.set = "Atchley", summary.fun = "mean")
...
* input.data: A data frame containing gene assignments.
...
```{r tidy = FALSE}
# Building an edit-distance-based network
