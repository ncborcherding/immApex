---
title: Making Deep Learning Models with Apex
author: 
...
vignette: >
  ...
  %\VignetteIndexEntry{Making Deep Learning Models with Apex}
...
**Apex** is meant to serve as an API for deep-learning models based on immune receptor sequencing. These functions extract or generate amino acid or nucleotide sequences and prepare them for deep learning tasks through [Keras](https://tensorflow.rstudio.com/guides/keras/basics). **Apex** is the underlying structure for the BCR models in [Ibex](https://github.com/ncborcherding/Ibex) and TCR models in [Trex](https://github.com/ncborcherding/Trex). It should be noted that the tools here are created for immune receptor sequences, they will work more generally for nucleotide or amino acid sequences. 

More information is available at the [Apex GitHub Repo](https://github.com/ncborcherding/Apex).

## Installation

```{r, eval = FALSE}
devtools::install_github("ncborcherding/Apex")
```
