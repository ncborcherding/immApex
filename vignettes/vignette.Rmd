...
One approach to encode amino acid sequences has been through geometric isometry, such as \href{GIANA}{https://pubmed.ncbi.nlm.nih.gov/34349111/}.
...
In order to extract sequences from the one-hot or property encoded matrices or arrays, we have a function called ```sequenceDecoder()```. This can be applied to any generative approaches to sequence generation.
...
* **call.threshold** The relative strictness of sequence calling with higher values being more
